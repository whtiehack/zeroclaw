...
impl Tool for CronAddTool {
    ...
    fn description(&self) -> &str {
        "Create a scheduled cron job (shell or agent) with cron/at/every schedules. \
         ...
         To deliver output to a channel (Discord, Telegram, Slack, Mattermost, QQ, WeCom, Lark, Feishu, Email), set \
            ...
            "properties": {
                ...
                "delivery": {
                    ...
                    "properties": {
                        ...
                        "channel": { "type": "string", "enum": ["telegram", "discord", "slack", "mattermost", "qq", "wecom", "lark", "feishu", "email"], "description": "Channel type to deliver to" },
